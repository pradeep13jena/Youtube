    ...
    <div className="flex flex-col">
      ...
      <Link to={`/watch?v=${cat._id }`}>
        ...
        <div className="flex gap-3 pl-2 py-2 flex-1 justify-between items-start">
          ...
          <div className="">
            <div onClick={() => setOpenModal(!openModal)} className="cursor-pointer hover:bg-gray-200 rounded-full w-10 h-10 flex items-center justify-end sm:justify-center hover:border-gray-300">
              <MoreVertOutlined
