          ...
          <div className="w-full">
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-3">
                <div
                  onClick={handleOpen}
                  className="cursor-pointer rounded-full w-8 h-8 md:w-10 md:h-10 flex items-center justify-center md:border-2 md:hover:bg-gray-100"
                >
                  <AddIcon />
                </div>
                <Modal
                ...
                <Link to={"/feed/channels"}>
                  <p className="py-2 px-4 border-2 rounded-full cursor-pointer hover:bg-gray-100">
                    View all
                  </p>
                </Link>
              </div>
